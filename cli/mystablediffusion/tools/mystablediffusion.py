...
# Caution
# this code is forked from dify official stable diffusion plugin
# this code is restricted by dify official stable diffusion plugin software license
# I'm not responsible for the troubles (at all) among this users
...
class MystablediffusionTool(Tool):
    def _invoke(
    ...
    def text2img(
        ...
        # sampler name from tool parameter
        draw_options["sampler_name"] = tool_parameters.get("sampleingmethod","")
        # cfg scale value from tool parameter
        draw_options["cfg_scale"] = tool_parameters.get("cfgscale","")
        # step counts from tool parameter
        draw_options["steps"] = tool_parameters.get("steps","")
        try:
